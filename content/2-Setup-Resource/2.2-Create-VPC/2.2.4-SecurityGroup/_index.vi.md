---
title : "Create các Security Group"
date :  2025-05-21 
weight : 4
chapter : false
pre : " <b> 2.2.4 </b> "
...
3. Cấu hình **Inbound rules**
    - Chọn **Add rule**
    - Type **Custom TCP** Port range **8080** Source **Custom** chọn **Secutiry group** chọn **Public-SG** đã Create ở trên
